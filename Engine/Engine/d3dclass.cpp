...
void D3DClass::FillDisplayModes()
{
	...
	ThrowIfFailed(result, "Failed to get the adapter (video card) description");
} 
...
void D3DClass::Initialize(bool fullscreen, float screenDepth, float screenNear)
{
	...
	depthBufferDesc.Width = m_screenWidth*m_scale;
	depthBufferDesc.Height = m_screenHeight*m_scale;
	...
	blendStateDescription.RenderTarget[0].SrcBlend = D3D11_BLEND_ONE; // D3D11_BLEND_SRC_ALPHA;
